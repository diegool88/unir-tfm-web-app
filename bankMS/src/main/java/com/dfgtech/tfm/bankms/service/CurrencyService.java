...
public class CurrencyService {
    ...
    /**
     * Get all the currencies with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<CurrencyDTO> findAllWithEagerRelationships(Pageable pageable) {
        return currencyRepository.findAllWithEagerRelationships(pageable).map(currencyMapper::toDto);
    }
    ...
    public Optional<CurrencyDTO> findOne(Long id) {
        ...
        return currencyRepository.findOneWithEagerRelationships(id)
            .map(currencyMapper::toDto);
    }
