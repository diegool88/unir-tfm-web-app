...
public class ProductResourceIT {
    ...
    private static final ProductCategory DEFAULT_CATEGORY = ProductCategory.CREDIT;
    private static final ProductCategory UPDATED_CATEGORY = ProductCategory.PORTFOLIO;
    ...
    private static final Affirmation DEFAULT_STATE = Affirmation.YES;
    private static final Affirmation UPDATED_STATE = Affirmation.NO;
    ...
    public static Product createEntity(EntityManager em) {
        ...
        product.setBankingEntity(bankingEntity);
        return product;
    }
    /**
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getMnemonic()).isEqualTo(DEFAULT_MNEMONIC);
    ...
    public void updateProduct() throws Exception {
        ...
        Product testProduct = productList.get(productList.size() - 1);
        assertThat(testProduct.getMnemonic()).isEqualTo(UPDATED_MNEMONIC);
