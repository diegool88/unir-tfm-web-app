...
import com.dfgtech.tfm.regionms.repository.CountryRepository;
import com.dfgtech.tfm.regionms.service.CountryService;
import com.dfgtech.tfm.regionms.service.dto.CountryDTO;
import com.dfgtech.tfm.regionms.service.mapper.CountryMapper;
...
public class CountryResourceIT {
    ...
    public void createCountry() throws Exception {
        ...
        assertThat(testCountry.getMnemonic()).isEqualTo(DEFAULT_MNEMONIC);
    ...
    public void updateCountry() throws Exception {
        ...
        Country testCountry = countryList.get(countryList.size() - 1);
        assertThat(testCountry.getMnemonic()).isEqualTo(UPDATED_MNEMONIC);
