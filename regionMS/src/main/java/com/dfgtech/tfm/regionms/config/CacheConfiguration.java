package com.dfgtech.tfm.regionms.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("regionMS");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("regionMS");
        ...
        config.getMapConfigs().put("com.dfgtech.tfm.regionms.domain.*", initializeDomainMapConfig(jHipsterProperties));
