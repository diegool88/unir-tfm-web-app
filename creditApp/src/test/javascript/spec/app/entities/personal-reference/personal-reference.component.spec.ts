...
import { PersonalReferenceComponent } from 'app/entities/personal-reference/personal-reference.component';
...
describe('Component Tests', () => {
  describe('PersonalReference Management Component', () => {
    let comp: PersonalReferenceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PersonalReferenceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new PersonalReference(123)],
            headers
          })
        )
      );
      ...
      expect(comp.personalReferences[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
