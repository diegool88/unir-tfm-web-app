...
import { TelephoneNumberComponent } from 'app/entities/telephone-number/telephone-number.component';
...
describe('Component Tests', () => {
  describe('TelephoneNumber Management Component', () => {
    let comp: TelephoneNumberComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TelephoneNumberComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.telephoneNumbers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
